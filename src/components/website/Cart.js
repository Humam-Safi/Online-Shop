              ...
              >
                ...
                <Card.Body className="text-center">
                  ...
                  <div className="d-flex justify-content-center align-items-center gap-2">
                    <span className="text-success fw-bold">${item.price - item.discount}</span>
                    {item.discount > 0 && (
                  ...
                  <button
                    ...
                    onMouseOver={(e) => {
                      ...
                      e.target.style.boxShadow = "0 8px 20px rgba(255, 0, 90, 0.4)";
                    }}
                    onMouseOut={(e) => {
                      e.target.style.transform = "scale(1)";
                      e.target.style.boxShadow = "0 5px 15px rgba(255, 0, 90, 0.3)";
                    }}
                  >
